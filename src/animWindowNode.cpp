...
animWindowNode::animWindowNode() : Node("animWindow")
{
    ...
    std::vector<std::vector<double>> X_base(12, std::vector<double>(2)), Y_base(12, std::vector<double>(2)), Z_base(12, std::vector<double>(2));
    std::vector<std::vector<double>> X_body(12, std::vector<double>(2)), Y_body(12, std::vector<double>(2)), Z_body(12, std::vector<double>(2));
    std::vector<std::vector<double>> X_prop(12, std::vector<double>(2)), Y_prop(12, std::vector<double>(2)), Z_prop(12, std::vector<double>(2));
